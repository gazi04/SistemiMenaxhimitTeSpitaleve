...
<body>
  ...
  <section class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url({{ asset('assets/home_page/images/bg_1.jpg') }})"
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 text ftco-animate">
            ...
            <p>
              <a href="#" class="btn btn-secondary px-4 py-3 mt-3">Shikoni punën tonë</a>
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row no-gutters">
        <div class="col-md-5 p-md-5 img img-2 mt-5 mt-md-0"
          style="background-image: url({{ asset('assets/home_page/images/about.jpg') }})"></div>
              ...
              <div class="col-lg-6">
                <div class="services-2 d-flex">
                  ...
                  <div class="text">
                    ...
                    <p>
                      Kujdesi parësor është niveli i parë i shërbimeve shëndetësore, duke ofruar parandalim, diagnozë
              ...
              <div class="col-lg-6">
                <div class="services-2 d-flex">
                  ...
                  <div class="text">
                    ...
                    <p>
                      Kontrolli i simptomave është procesi i vlerësimit dhe menaxhimit të shenjave dhe ankesa që një
                      ...
                      pacientit për të siguruar që simptomat të kontrollohen dhe të menaxhohen në mënyrë efikase.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
          ...
          <div class="staff">
            <div class="img-wrap d-flex align-items-stretch">
              <div class="img align-self-stretch"
                style="background-image: url({{ asset('assets/home_page/images/doc-1.jpg') }})"></div>
            </div>
            <div class="text pt-3 text-center">
              ...
              <div class="faded">
                <p>
                  Unë jam Naim Zeka, neurolog me përvojë në diagnostikimin dhe trajtimin e çrregullimeve të sistemit
                  nervor. Përkushtohem që të ofroj kujdes cilësor për pacientët dhe të përdor metodat më të fundit për
                  menaxhimin e kushteve neurologjike. Gjatë karrierës sime, kam ndihmuar shumë pacientë të përballojnë
                  sfida të ndryshme neurologjike dhe të përmirësojnë cilësinë e jetës së tyre.
                </p>
        ...
        <div class="col-md-6 col-lg-3 ftco-animate">
          <div class="staff">
            <div class="img-wrap d-flex align-items-stretch">
              <div class="img align-self-stretch"
                style="background-image: url({{ asset('assets/home_page/images/doc-2.jpg') }})"></div>
            </div>
            <div class="text pt-3 text-center">
              <h3>Dr.Ardian Shabani</h3>
              <span class="position mb-2">Oftamologe</span>
              <div class="faded">
                <p>
                  Unë jam Ardian Shabani, oftamolog me përvojë në trajtimin e sëmundjeve të syrit. Kam aftësi të
                  shkëlqyera në diagnostikimin dhe trajtimin e kushteve oftalmologjike, duke përdorur teknologji
                  moderne. Përkushtohem të ofroj kujdes të shkëlqyer për pacientët dhe të ruaj shëndetin e syve të tyre.
                </p>
                <ul class="ftco-social text-center">
                  <li class="ftco-animate">
                    <a href="#"><span class="icon-twitter"></span></a>
        ...
        <div class="col-md-6 col-lg-3 ftco-animate">
          <div class="staff">
            <div class="img-wrap d-flex align-items-stretch">
              <div class="img align-self-stretch"
                style="background-image: url({{ asset('assets/home_page/images/doc-3.jpg') }})"></div>
            </div>
            <div class="text pt-3 text-center">
              ...
              <div class="faded">
                <p>
                  Unë jam Bekim Kosumi, stomatolog i specializuar në diagnostikimin dhe trajtimin e problemeve dentare.
                  Përdor teknika moderne dhe qasje të kujdesshme për të ofruar trajtime pa dhimbje dhe efektive. Kam
                  përkushtim të plotë në kujdesin për shëndetin e gojës dhe dhëmbëve të pacientëve të mi.
                </p>
                <ul class="ftco-social text-center">
                  <li class="ftco-animate">
                    <a href="#"><span class="icon-twitter"></span></a>
        ...
        <div class="col-md-6 col-lg-3 ftco-animate">
          <div class="staff">
            <div class="img-wrap d-flex align-items-stretch">
              <div class="img align-self-stretch"
                style="background-image: url({{ asset('assets/home_page/images/doc-4.jpg') }})"></div>
            </div>
            <div class="text pt-3 text-center">
              ...
              <div class="faded">
                <p>
                  Unë jam Osman Ramadani, kardiolog me përvojë në trajtimin e problemeve të zemrës. Specializohem në
                  diagnostikimin dhe menaxhimin e sëmundjeve kardiovaskulare, duke përdorur metoda moderne dhe teknika
                  të avancuara. Jam i përkushtuar për të siguruar kujdes të shkëlqyer dhe për të ndihmuar pacientët të
                  mbajnë zemrën e shëndetshme.
                </p>
                <ul class="ftco-social text-center">
                  <li class="ftco-animate">
                    <a href="#"><span class="icon-twitter"></span></a>
