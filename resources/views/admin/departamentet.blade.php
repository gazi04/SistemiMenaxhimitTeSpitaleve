        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="{{ url('departmentet') }}"><i class="fa fa-hospital-o" class="active"></i>
        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-7 col-7 text-right m-b-30">
                    <a href="{{ url('shto-departamente')}}" class="btn btn-primary btn-rounded">Shto Departament</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <table class="table table-striped custom-table mb-0 datatable">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>Stomatologjia</td>
                                    <td class="sorting_1 description">
                                        Fokusohet në shëndetin oral, dhëmbët dhe mirëqenien
                                        dentare.
                                    </td>
                                    <td class="text-right">
                                        <div class="action-buttons">
                                            <a href="{{ url('modifiko-departament')}}" class="btn btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td>Neurologjia</td>
                                    <td class="sorting_1 description">
                                        Kujdeset për shëndetin e trurit, nervave dhe sistemit
                                        nervor
                                    </td>
                                    <td class="text-right">
                                        <div class="action-buttons">
                                ...
                                <tr>
                                    ...
                                    <td>Oftalmologjia</td>
                                    <td class="sorting_1 description">
                                        Fokusuar në shëndetin dhe mirëqenien e syve.
                                    </td>
                                    <td class="text-right">
                                        <div class="action-buttons">
                                            <a href="{{ url('modifiko-departament')}}" class="btn btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td>Ortopedia</td>
                                    <td class="sorting_1 description">
                                        Trajton problemet e kockave, muskujve dhe kyçeve.
                                    </td>
                                    <td class="text-right">
                                        <div class="action-buttons">
                                            <a href="{{ url('modifiko-departament')}}" class="btn btn-primary">
                                ...
                                <tr>
                                    <td>5</td>
                                    <td>Departamenti i Kancerit</td>
                                    <td class="sorting_1 description">
                                        Fokusuar në diagnostikimin dhe trajtimin e sëmundjeve
                                        kanceroze.
                                    </td>
                                    <td class="text-right">
                                        <div class="action-buttons">
                                ...
                                <tr>
                                    <td>6</td>
                                    <td>Departamenti i ORL</td>
                                    <td class="sorting_1 description">
                                        Kujdeset për shëndetin e veshëve, hundës dhe fytit.
                                    </td>
                                    <td class="text-right">
                                        <div class="action-buttons">
                                            <a href="{{ url('modifiko-departament')}}" class="btn btn-primary">
