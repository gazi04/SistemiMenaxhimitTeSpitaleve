        ...
        <div class="content">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h4 class="page-title">Modifiko Infermierin/en</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <form action="{{ route('edit-nurse') }}" method="POST">
                        @csrf
                        <input type="hidden" name="id" id="form-id" value="{{ $id }}">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>ID e Infermierit/es
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Emri</label>
                                    <input class="form-control" name="emri" type="text" placeholder="Shkruani emrin" value="{{ $nurseName }}" />
                            ...
                            <div class="col-sm-6">
                                <div class="from-group">
                                    <label>Mbiemri</label>
                                    <input class="form-control" name="mbiemri" type="text" placeholder="Shkruani mbiemrin" value="{{ $nurseLastName }}" />
                            ...
                            <div class="col-sm-12">
                                <div class="from-group">
                                    ...
                                    <input class="form-control" name="email" type="email" placeholder="Shkruani email-in" value="{{ $nurseEmail }}" />
